...
by the standard apps (stock, purchase, account, loyalty, pos_loyalty, hr).
    ...
    'data': [
        ...
        'security/pos_retail_branch_rules.xml',
        ...
        'views/pos_config_kiosk_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pos_retail/static/src/backend/color_list.js',
            'pos_retail/static/src/backend/color_list.scss',
        ...
        'point_of_sale._assets_pos': [
            ...
            'pos_retail/static/src/receipt/invoice_receipt.xml',
            ...
            'pos_retail/static/src/overrides/product_search.js',
            'pos_retail/static/src/overrides/payment_lines.js',
            ...
            'pos_retail/static/src/overrides/phantom_payment_line.js',
