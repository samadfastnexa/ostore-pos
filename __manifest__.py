...
by the standard apps (stock, purchase, account, loyalty, pos_loyalty, hr).
    ...
    'data': [
        ...
        'data/pos_retail_access_permission_system_data.xml',
        ...
        'report/pos_retail_base_report.xml',
        'report/pos_retail_customer_ledger_report.xml',
        'report/pos_retail_vendor_statement_report.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pos_retail/static/src/backend/report_registry.js',
        ...
        'point_of_sale._assets_pos': [
            ...
            'pos_retail/static/src/overrides/cashier_welcome_popup.js',
            'pos_retail/static/src/overrides/cashier_welcome_popup.xml',
            'pos_retail/static/src/overrides/cashier_welcome_popup.scss',
            ...
            'pos_retail/static/src/overrides/receive_payment_popup.js',
            'pos_retail/static/src/overrides/receive_payment_popup.xml',
            'pos_retail/static/src/overrides/payment_receipt_popup.js',
            'pos_retail/static/src/overrides/payment_receipt_popup.xml',
